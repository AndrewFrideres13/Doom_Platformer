var level_hell = {
  ...
  scoreText:null,
    ...
    update: function () { 
      ...
      if (game.physics.arcade.collide(demons, bullets, this.killEnemies, null, this)) {
        demonDeaths = true;
        impDeaths = false;
      } else if (game.physics.arcade.collide(imps, bullets, this.killEnemies, null, this)) {
        demonDeaths = false;
        impDeaths = true; 
      } 
